...
public class Home extends AppCompatActivity {
    ...
    Button  use_cam, bt_copy, about_us;
    Space space;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        use_cam = findViewById(R.id.use_cam);
        ...
        use_cam.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        about_us.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), AboutUs1.class));
            }
        });
